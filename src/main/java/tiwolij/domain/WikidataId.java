...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "id", scope = WikidataId.class)
public class WikidataId implements Serializable {
